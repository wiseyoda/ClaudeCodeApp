...
Implement roadmap task: Replace hard-coded path stripping in Project.title.
...
- Apply the Replace hard-coded path stripping in Project.title change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/Models.swift | Use basename or displayName |
...
- [ ] Replace hard-coded path stripping in Project.title is implemented as described
...
rg -n "home-dev-workspace" CodingBridge
