...
Implement roadmap task: Simplify slash command handling.
...
- Apply the Simplify slash command handling change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Replace switch with registry |
...
rg -n "handleSlashCommand" CodingBridge
