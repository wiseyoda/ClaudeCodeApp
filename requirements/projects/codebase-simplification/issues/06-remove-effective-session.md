...
Implement roadmap task: Remove effectiveSessionToResume computed property.
...
- Apply the Remove effectiveSessionToResume computed property change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Use a single sessionId source |
...
rg -n "effectiveSessionToResume" CodingBridge
