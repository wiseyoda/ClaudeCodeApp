...
- Apply the Reconfigure long-lived services on serverURL change change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/CodingBridgeApp.swift | Propagate serverURL updates |
| CodingBridge/SessionStore.swift | Support reconfigure |
| CodingBridge/PermissionManager.swift | Reconfigure API client |
| CodingBridge/Utilities/HealthMonitorService.swift | Update server URL |
...
- [ ] Reconfigure long-lived services on serverURL change is implemented as described
