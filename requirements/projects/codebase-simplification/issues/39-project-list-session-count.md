...
Implement roadmap task: Include session count in project list response.
...
- Apply the Include session count in project list response change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/CLIBridgeAPIClient.swift | Use sessionCount from projects |
| CodingBridge/ContentView.swift | Remove extra count calls |
...
rg -n "sessionCount" CodingBridge
...
**Change Required**: Return sessionCount in /projects

**API Impact**:
- Endpoint: `GET /projects`
- Change: Add sessionCount field for each project
