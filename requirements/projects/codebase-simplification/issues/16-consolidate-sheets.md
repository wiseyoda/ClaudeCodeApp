...
Implement roadmap task: Consolidate sheet booleans into activeSheet enum.
...
- Apply the Consolidate sheet booleans into activeSheet enum change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Replace booleans with enum |
| CodingBridge/ChatView.swift | Switch on active sheet enum |
...
rg -n "showingHelpSheet" CodingBridge
