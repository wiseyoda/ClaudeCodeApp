# Issue #37: Typed tool input instead of JSONValue dict
...
Implement roadmap task: Typed tool input instead of JSONValue dict.
...
- Apply the Typed tool input instead of JSONValue dict change in the listed files
...
- [x] Typed tool input instead of JSONValue dict is implemented as described
...
**Change Required**: Provide typed tool inputs or inputDescription

**API Impact**:
- Endpoint: `WebSocket tool events`
- Change: Typed schemas for common tools
...
| 2026-01-02 | Verified | Confirmed tool events prefer inputDescription with JSONValue fallback for legacy parsing |
