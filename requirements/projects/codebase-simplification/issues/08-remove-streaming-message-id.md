...
Implement roadmap task: Eliminate streamingMessageId/streamingMessageTimestamp.
...
- Apply the Eliminate streamingMessageId/streamingMessageTimestamp change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Remove streaming message identifiers |
| CodingBridge/ChatView.swift | Use adapter state directly |
...
rg -n "streamingMessageId" CodingBridge
