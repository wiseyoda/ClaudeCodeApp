# Issue #10: Remove toolUseMap dictionary
...
Implement roadmap task: Remove toolUseMap dictionary.
...
- Apply the Remove toolUseMap dictionary change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Use tool name from events |
...
- [x] Remove toolUseMap dictionary is implemented as described
...
| Date | Action | Outcome |
|------|--------|---------|
| 2026-01-02 | Started implementation | Audited toolUseMap usage in ChatViewModel.swift |
| 2026-01-02 | Completed | Removed toolUseMap dictionary (5 references); tool name now taken directly from StreamEvent. Build passes, no warnings. |
| 2026-01-02 | Verified | Confirmed toolUseMap removal and updated ChatViewModel cleanup logic |
