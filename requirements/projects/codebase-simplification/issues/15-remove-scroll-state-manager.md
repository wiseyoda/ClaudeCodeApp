...
Implement roadmap task: Remove ScrollStateManager.
...
- Apply the Remove ScrollStateManager change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Replace with native ScrollViewReader |
| CodingBridge/ChatView.swift | Remove custom scroll manager hooks |

### Files to Delete

| File | Reason |
|---|---|
| CodingBridge/Utilities/ScrollStateManager.swift | Custom scroll manager no longer needed |
...
rg -n "ScrollStateManager" CodingBridge

# Line count verification (if removing code)
# wc -l CodingBridge/Utilities/ScrollStateManager.swift
```
