...
Implement roadmap task: Remove message pruning.
...
- Apply the Remove message pruning change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Remove pruneMessagesIfNeeded |
...
rg -n "pruneMessagesIfNeeded" CodingBridge
