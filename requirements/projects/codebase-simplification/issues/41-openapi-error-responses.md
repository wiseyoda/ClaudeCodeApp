...
Implement roadmap task: Document error responses in OpenAPI.
...
- Apply the Document error responses in OpenAPI change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/CLIBridgeAPIClient.swift | Use generated error types |
...
rg -n "CLIBridgeAPIError" CodingBridge
...
**Change Required**: Add error response schemas to OpenAPI

**API Impact**:
- Endpoint: `All REST endpoints`
- Change: Document 4xx/5xx schemas

**GitHub Issue**: https://github.com/wiseyoda/cli-bridge/issues/14
