...
Implement roadmap task: Idempotent reconnection protocol.
...
- Apply the Idempotent reconnection protocol change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/CLIBridgeManager.swift | Remove dedupe once server guarantees |
...
rg -n "receivedMessageIds" CodingBridge
...
**Change Required**: Server-side cursor tracking for exactly-once replay

**API Impact**:
- Endpoint: `WebSocket reconnect`
- Change: Guaranteed no duplicate replay

**GitHub Issue**: https://github.com/wiseyoda/cli-bridge/issues/20
