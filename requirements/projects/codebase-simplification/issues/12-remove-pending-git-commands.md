...
Implement roadmap task: Remove pendingGitCommands tracking.
...
- Apply the Remove pendingGitCommands tracking change in the listed files
...
| File | Change |
|---|---|
| CodingBridge/ViewModels/ChatViewModel.swift | Refresh git status on completion only |
...
rg -n "pendingGitCommands" CodingBridge
